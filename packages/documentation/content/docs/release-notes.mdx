...
<div className="flex flex-col space-y-4 md:space-y-6">
  <div className="flex items-center gap-3">
    ...
    <div><strong>Chrome Web Store</strong>: <a href="https://chrome.google.com/webstore/detail/video-roll-all-in-one-vid/cokngoholafkeghnhhdlmiadlojpindm?hl=en" target="_blank" rel="noopener noreferrer">v2.0.5 (Under review, will be published automatically after approval)</a></div>
  </div>
  
  <div className="flex items-center gap-3">
    <Edge className="w-6 h-6" />
    <div><strong>Microsoft Edge Add-ons</strong>: <a href="https://microsoftedge.microsoft.com/addons/detail/video-roll/indeeigndpaahbcegcanpmbenmkbkmmn" target="_blank" rel="noopener noreferrer">v2.0.5 (Under review, will be published automatically after approval)</a></div>
  </div>
