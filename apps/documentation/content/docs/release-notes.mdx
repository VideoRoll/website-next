...
<div className="flex flex-col space-y-4 md:space-y-6">
  ...
  <div><strong>Chrome Web Store</strong>: <a href="https://chrome.google.com/webstore/detail/video-roll-all-in-one-vid/cokngoholafkeghnhhdlmiadlojpindm?hl=en" target="_blank" rel="noopener noreferrer">v2.0.7 (Publishes automatically once approved)</a></div>
  </div>
  
  <div className="flex items-center gap-3">
    <Edge className="w-6 h-6" />
  <div><strong>Microsoft Edge Add-ons</strong>: <a href="https://microsoftedge.microsoft.com/addons/detail/video-roll/indeeigndpaahbcegcanpmbenmkbkmmn" target="_blank" rel="noopener noreferrer">v2.0.7 (Publishes automatically once approved)</a></div>
  </div>
...
### New Features
 ...
 <Image src={AudioCaptureType} width={400} alt="Audio capture modes" />
 ...
 <Image src={VrInside} width={400} alt="VR mode overlay" />
...
### Developer Experience
 ...
 - Released the [bun-tasks](https://www.npmjs.com/package/bun-tasks) package to orchestrate concurrent tasks, significantly speeding up extension builds.
